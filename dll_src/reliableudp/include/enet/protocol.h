...
#define ENET_PROTOCOL_HEADER_PEER_MASK		0x8000
#define ENET_PROTOCOL_HEADER_FLAG_CRC       (1 << 0)
#define ENET_PROTOCOL_HEADER_FLAG_COMPRESS  (1 << 1)
#define ENET_PROTOCOL_HEADER_FLAG_SECURE	(1 << 2)
#define ENET_PROTOCOL_HEADER_FLAG_SENT_TIME (1 << 3)
...
typedef struct
{
   ...
   enet_uint16 peerID;
   enet_uint8 protoMajor;
   enet_uint8 protoMinor;
   enet_uint8 flags;
   enet_uint16 sentTime;	// do not move from last position, code in protocol.c
} ENetProtocolHeader;
